...
void EventHandler::OnEvent(SDL_Event* event)
{
    switch(event->type)
    {
        ...
        case SDL_KEYDOWN: OnKeyDown(event->key.keysym.sym,event->key.keysym.mod,event->key.keysym.scancode);
                          break;


        case SDL_KEYUP: OnKeyUp(event->key.keysym.sym,event->key.keysym.mod,event->key.keysym.scancode);
                        break;
        ...
        case SDL_JOYHATMOTION: OnJoyHat(event->jhat.which,event->jhat.hat,event->jhat.value);
                               break;
        ...
        case SDL_JOYBUTTONUP: OnJoyButtonUp(event->jbutton.which,event->jbutton.button);
                              break;
